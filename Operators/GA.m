function Offspring = GA(Population,type,Parameter)
...
%         calObj = false;
    ...
    switch type
        case 'upper'
            Lower = repmat(Global.upper_domain(1,:),2*N,1);
            Upper = repmat(Global.upper_domain(2,:),2*N,1);
        case 'lower'
            Lower = repmat(Global.lower_domain(1,:),2*N,1);
            Upper = repmat(Global.lower_domain(2,:),2*N,1);
        case 'bilevel'
            Lower = repmat([Global.upper_domain(1,:),Global.lower_domain(1,:)],2*N,1);
            Upper = repmat([Global.upper_domain(2,:),Global.lower_domain(2,:)],2*N,1);
    end
